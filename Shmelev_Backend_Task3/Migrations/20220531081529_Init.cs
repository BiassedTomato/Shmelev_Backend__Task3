        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModeratedBoardId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModeratedBoards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ModeratedBoards_Boards_BoardId",
                        column: x => x.BoardId,
            ...
            migrationBuilder.CreateTable(
                name: "ForumUserModeratedBoard",
                columns: table => new
                {
                    ModeratedBoardsId = table.Column<int>(type: "int", nullable: false),
                    ModeratorsId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForumUserModeratedBoard", x => new { x.ModeratedBoardsId, x.ModeratorsId });
                    table.ForeignKey(
                        name: "FK_ForumUserModeratedBoard_AspNetUsers_ModeratorsId",
                        column: x => x.ModeratorsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ForumUserModeratedBoard_ModeratedBoards_ModeratedBoardsId",
                        column: x => x.ModeratedBoardsId,
                        principalTable: "ModeratedBoards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForumUserModeratedBoard_ModeratorsId",
                table: "ForumUserModeratedBoard",
                column: "ModeratorsId");

            migrationBuilder.CreateIndex(
                name: "IX_ModeratedBoards_BoardId",
                table: "ModeratedBoards",
                column: "BoardId",
                unique: true);
